...
//{
//    public class BuildSampleCategories
//    {
//        private ApplicationDbContext db = new ApplicationDbContext();

//        public void BuildSample(int hhId)
//        {
//            // Categories // Categories // Categories // Categories // Categories // Categories // Categories // Categories //
//            // Categories // Categories // Categories // Categories // Categories // Categories // Categories // Categories //
//            db.Categories.Add(new Category { IsIncomeCategory = true, Name = "Income", HouseholdId = hhId });
...
//            var catId = db.Categories.FirstOrDefault(c => c.Name == "Income").Id;
//            db.BudgetItems.Add(new BudgetItem { CategoryId = catId, Desc = "Monthy Pay (after Taxes)" });
...
//            catId = db.Categories.FirstOrDefault(c => c.Name == "Housing").Id;
...
//            catId = db.Categories.FirstOrDefault(c => c.Name == "Utilities").Id;
...
//            catId = db.Categories.FirstOrDefault(c => c.Name == "Health/Medical").Id;
...
//            catId = db.Categories.FirstOrDefault(c => c.Name == "Transportation").Id;
...
//            catId = db.Categories.FirstOrDefault(c => c.Name == "Credit Cards / Loans").Id;
...
//            catId = db.Categories.FirstOrDefault(c => c.Name == "Food/Entertainment").Id;
...
//            catId = db.Categories.FirstOrDefault(c => c.Name == "Children").Id;
...
//            catId = db.Categories.FirstOrDefault(c => c.Name == "Personal").Id;
...
//            catId = db.Categories.FirstOrDefault(c => c.Name == "Savings").Id;
...
//            db.Transactions.Add( new Transaction { CategoryId = catId, Desc = "Beginning Balance", Amt = 0M, BankAccountId = 1, date = System.DateTimeOffset.Now });
